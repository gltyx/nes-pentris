...
var cnItems = {
    ...
    "P - TOGGLE DARK MODE": "P - 切换深色模式",
    "- MADE BY DEMONIN": "— 由DEMONIN",
    "- MOVE LEFT": "- 向左移动",
    "- MOVE RIGHT": "- 向右移动",
    "- ROTATE LEFT": "- 向左旋转",
    "- ROTATE RIGHT": "- 向右旋转",
    ...
    "BASED ON THE": "基于",
    "BEST SCORES": "最高分",
    "BY ZOHASSADAR": "作者：zohassadar",
    "CHANGE": "修改",
    "CLOSE": "关闭",
    "CONTROLS:": "控制:",
    "ESCAPE - RETURN TO MENU": "Esc -返回菜单",
    "INFO": "信息",
    "NES PENTRIS": "NES PENTRIS",
    "ORIGINAL ROM HACK": "原始ROM破解",
    "PRESS A KEY": "请按一个键",
    "": "",
    "": "",
    "": "",
